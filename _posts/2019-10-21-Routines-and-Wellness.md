---
layout: post
title:  "Routines and Wellness"
date:   2019-10-21 8:52:00 -0800
...
### <span title="Sorry, no image because to-dos are kind of personal">To-Dos</span> ###

To-Dos are pretty self-explanatory; they're list items that I'd like to get done _eventually_. They don't really need to be done today, but they should be done soon. Things that I'd like to keep in mind are listed here. That includes website maintenance tasks, appointments, and reminders to go shopping[^list]. Generally speaking, if I find myself doing nothing, I can usually turn to my to-do list and find something to do.

### Rewards ###

<span title="The meat and potatoes">![My Habitica rewards]({{ site.url }}/assets/routines-and-2019-10-21-wellness/3.png)</span>

Habitica makes to-do lists fun by gamifying them. Completing a task gives you coins, experience, and mana which can be used in the app's battles and quests. Engaging in negative habits makes you lose health[^hp]. I don't have anyone to party up with on Habitica and I'm not all that interested in the guilds system, so experience and mana don't do much for me other than give me <span title="Monkey brain still likes to watch the numbers go up, though">shiny numbers to look at</span>.

The coins go beyond the usual RPG-style rewards they give you. In Habitica, you can set up your own rewards. In this case, I've set up a monetary reward for myself: if I earn 10 coins, I can redeem them for <span title="Good boy points for being a good boy">one dollar</span>. This is perfect for me because while I like buying nice things, I'm a penny-pincher and a stickler for rules. To that end, I've set up a habit for spending the right money on the right things. If I want a new shiny thing, I have to either save up specifically for it or spend from the money I've saved with Habitica. If I spend properly, I get to reward myself. If I don't, I lose health.
...
[^list]: I use [Google Keep](https://keep.google.com) for my shopping list.
[^hp]: I don't know what happens when you lose all of your health.